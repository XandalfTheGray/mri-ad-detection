...
# * get_imgs.py
# * sort_imgs.py
# * gen_data_and_intrplt.py
# * test_accuracy.py
# * prep_data.py 

import get_imgs
import sort_imgs
#import gen_data_and_intrplt as genDnI
#import prep_data
import os, sys

# The sort_imgs function has been run (get_imgs didn't need to be?)
sort_imgs.sort_imgs("C:/Users/xapic/source/repos/PythonApplication/PythonApplication")

# Runs get_imgs
get_imgs.get_imgs("C:/Users/xapic/source/repos/PythonApplication/PythonApplication/ADNI_Complete_1Yr_1.5T", "C:/Users/xapic/source/repos/PythonApplication/PythonApplication/ADNI_Pictures" )

## Gets filenames from input folder
#genDnI.getFileNames()
